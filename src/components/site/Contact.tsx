  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-[1400px] grid-cols-1 gap-10 px-4 sm:px-6 lg:px-8 md:grid-cols-2 md:gap-14">
        <div
          className="reveal order-1 min-w-0 md:order-none md:col-start-1 md:row-start-1"
          data-reveal
        >
        ...
        <form
          ...
          className="reveal surface-panel order-2 min-w-0 space-y-5 rounded-2xl p-6 md:order-none md:col-start-2 md:row-start-1 md:row-span-2 md:p-8"
        >
        ...
        <div
          className="reveal order-3 mt-8 min-w-0 grid grid-cols-1 gap-3 sm:grid-cols-3 md:order-none md:col-start-1 md:row-start-2 md:mt-0 md:grid-cols-1 md:gap-4 md:self-end"
          data-reveal
        >
          <a
            href={WHATSAPP_LINK}
